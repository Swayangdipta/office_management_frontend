...
import { deleteEmployeeHrm } from "./helper/euApiCalls";
import { useAuthContext } from "../../context/AuthContext";
import toast from "react-hot-toast";

const DeletionModal = ({setIsConfirmationOpen = f => f, employee_id, setToRemove = f => f}) => {
    ...
    const handleDelete = () => {
        ...
        deleteEmployeeHrm(endUser?._id,token,employee_id).then(data => {
            ...
            return toast.error('Failed to delete employee.')
        }).catch(error => {
            console.error(error)
        })
    }
